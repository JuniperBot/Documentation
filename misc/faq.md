...
{% hint style="warning" %}
Будьте внимательны, так как участник с этими правами способен изменить любой параметр в [панели управления](../#configure). Он сможет даже получить роли выше собственных при желании.
{% endhint %}
...
Изучите статью [Пользовательские команды](../cmd/custom-commands/#interface). Настройки прав доступа применимы и для встроенных команд.
