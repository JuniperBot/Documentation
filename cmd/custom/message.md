...
10 — Сам текст сообщения. Здесь можно использовать различные [переменные шаблонов](../../features/template-variables/), здесь выполняется код [шаблонного движка](https://docs.juniper.bot/features/template-engine);  
