...
## Управление <a id="control-commands"></a>
...
Команда полностью останавливает воспроизведение и очищает список очереди.
