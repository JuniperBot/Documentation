...
Покажет информацию о распространении бушующего коронавируса COVID-19
...
| Параметр | Обязательный | Тип | Описание |
| :--- | :--- | :--- | :--- |
| `страна` | Нет | Строка | Наименование страны на английском языке, по которой нужно получить информацию. Если не вводить, команда отобразит список всех стран, пораженных коронавирусом в порядке количества случаев заболевания. |
{% endtab %}
{% endtabs %}
