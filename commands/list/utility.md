...
{% hint style="info" %}
Логические операции всегда в результате дают число: 1 или 0 как истина или лож соответственно. При вычислении логических операций правдой считается любое отличное от 0 число.
{% endhint %}
...
| IF\(условие, значение\_истины, значение\_лжи\) | Условный оператор, возвращает нужное значение в результате вычисления указанного условия |
...
| ACOSH\(выражение\) | Возвращает угол гиперболического синуса \(в градусах\) |
