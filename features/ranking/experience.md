...
* _count_ - количество активных \(см. условия выше\) участников в голосовом канале;
...
1. Опыт и время начисляются активным \(см. условия выше\) участникам только если суммарно в голосовом канале как минимум два активных участника;
