...
Данное руководство постарается объяснить все основы простым и понятным языком насколько это возможно, наберитесь терпения и внимательно изучите весь раздел целиком.
