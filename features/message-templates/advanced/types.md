...
У некоторых функций в таблицах выше может указываться квота вызовов. Квота означает сколько раз можно вызвать эту функцию за шаблон. Вызовы, превышающие указанную квоту, будут проигнорированы и не будут выполнять никаких действий.
...
</table>\* У всех функций изменения ролей общий счётчик квоты вызовов.
...
| `remainingExp` | [Число](syntax/expressions.md#primitivy) | Опыт участника на текущем уровне |
| `levelExp` | [Число](syntax/expressions.md#primitivy) | Суммарный необходимый опыт на текущем уровне |
...
| Функция | Параметры | Возвращает | Описание | Квота |
| :--- | :--- | :--- | :--- | :---: |
...
\* У всех функций отправки сообщений общий счётчик квоты вызовов.
...
</table>\* У всех функций отправки сообщений общий счётчик квоты вызовов.

### Attribute

Этот тип данных описывает атрибуты участников. С помощью атрибутов можно хранить какие-либо собственные привязанные к участникам данные.
...
</table>\* У всех функций обновления значения общий счётчик квоты вызовов \(в рамках одного атрибута\).
